relationship_matrix <- function(family){

if(family == "A")
{
  #pairwise kinship relations found in the family.
  ...
  for(i in 1:length(files))
  {
    ...
    } else if(isTRUE(grep("Dads",files[i]) == 1)){ # if the vcf file is Father's
      print("dad")
